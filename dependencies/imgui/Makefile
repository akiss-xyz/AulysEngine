...
ifeq ($(config),debug)
TARGETDIR = build/Debug_linux_x86_64/ImGui
TARGET = $(TARGETDIR)/libImGui.a
OBJDIR = build/int/Debug_linux_x86_64/ImGui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O0 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O0 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),release)
TARGETDIR = build/Release_linux_x86_64/ImGui
TARGET = $(TARGETDIR)/libImGui.a
OBJDIR = build/int/Release_linux_x86_64/ImGui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),dist)
TARGETDIR = build/Dist_linux_x86_64/ImGui
TARGET = $(TARGETDIR)/libImGui.a
OBJDIR = build/int/Dist_linux_x86_64/ImGui
